...
// Endpoint var is environment variable set in lambda function
// Inside AWS => Lambda / Functions / Configuration / Environment variables
// Key: myProject_elasticsearch_endpoint
// Value: search-MyProject-xxxxxxxxx.eu-west-1.es.amazonaws.com
// You have to export your endpoint from the creation of this one and
// store it somewhere you can access it for me it's consul, but you can
// use AWS SSM Parameter Store
var endpoint = process.env.myProject_elasticsearch_endpoint;
